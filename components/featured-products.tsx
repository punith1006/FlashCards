    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <Button 
            variant="ghost" 
            className="text-orange-500 hover:text-orange-600 font-semibold text-lg p-0 hover:bg-transparent"
          >
            Explore All →
          </Button>
        </div>
            ...
            {products.map((product) => (
              ...
              >
                <CardContent className="p-6 h-full flex flex-col">
                  ...
                  />
                  <h4 className="text-xl font-semibold text-slate-800 mb-2 flex-shrink-0">
                    {product.name}
                  </h4>
