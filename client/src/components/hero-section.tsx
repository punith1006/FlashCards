    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto animate-fade-in">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          Get your health<br />
          <span className="highlight-text">back on track</span>
        </h1>
        ...
        <Button 
          size="lg"
          className="bg-[hsl(13,100%,60%)] hover:bg-[hsl(13,100%,50%)] text-white font-semibold px-8 py-4 rounded-full text-lg transition-all duration-300 hover:scale-105 shadow-lg"
        >
          Shop Now
        </Button>
