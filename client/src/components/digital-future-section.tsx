...
export function DigitalFutureSection() {
  ...
  return (
    ...
    >
      ...
      {/* Testimonials Section - Seamlessly attached */}
      <section className="bg-gray-50 pb-20">
        <div className="container mx-auto px-8 max-w-[1400px] pt-16">
          ...
          <div className="hidden lg:grid lg:grid-cols-4 gap-6 items-start">
            ...
            <div className="space-y-6">
              <div className="bg-gray-900 text-white rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/60 to-black/80 z-10"></div>
                <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=600&fit=crop&crop=center')"}}></div>
                <div className="relative z-20 flex flex-col h-full">
                  ...
                  <div className="flex-shrink-0">
                    <h3 className="text-white text-3xl font-bold leading-none">Ole Ole Burrito</h3>
                    <div className="text-sm font-normal mt-1 text-white/80">Edgar Martinez</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105" 
                style={{
                ...
                <div className="mb-6">
                  <h3 className="text-gray-900 text-2xl font-bold leading-tight mb-2">Riceful</h3>
                  <p className="text-gray-600 text-base font-medium">1st Okinawa Onigiri Shop in the US</p>
                </div>
                <div className="flex-1 mb-8 overflow-y-auto scrollbar-hide">
                ...
                <div className="flex items-center gap-3 mt-auto">
                  <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0">
                    <img 
                      src="https://ui-avatars.com/api/?name=Kai+Tang&background=4F46E5&color=fff&size=40"
                      alt="Kai Tang"
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div>
                    <div className="font-medium text-sm text-gray-900">Owner, Kai Tang</div>
                    <div className="text-xs text-gray-500 mt-0.5">Snackpass Partner Since 2020</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-900 text-white rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/60 to-black/80 z-10"></div>
                <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=600&fit=crop&crop=center')"}}></div>
                <div className="relative z-20 flex flex-col h-full pt-16">
                  <div className="mb-1">
                  ...
                  <div className="flex-shrink-0">
                    <h3 className="text-white text-3xl font-bold leading-none">Empanada Factory</h3>
                    <div className="text-sm font-normal mt-1 text-white/80">Marcelo Gutierrez</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto pb-6 scrollbar-hide">
              <div className="flex gap-6 px-4 min-w-max">
                <div className="w-80 flex-shrink-0">
                  <div className="bg-gray-900 text-white rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden shadow-xl">
                    <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/60 to-black/80 z-10"></div>
                    <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=600&fit=crop&crop=center')"}}></div>
                    <div className="relative z-20 flex flex-col h-full">
                      <div className="flex-1"></div>
                      <div className="flex-1 mb-8">
                        <blockquote className="leading-relaxed text-lg font-normal text-white">
                          "Everything is connected. Customers can order in-store, online, or via the app and always earn points."
                        </blockquote>
                      </div>
                      <div className="flex-shrink-0">
                        <h3 className="text-white text-3xl font-bold leading-none">Ole Ole Burrito</h3>
                ...
                <div className="w-80 flex-shrink-0">
                  <div className="rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden shadow-xl" style={{
                    background: 'rgba(254, 241, 225, 0.35)',
                    backdropFilter: 'blur(40px) saturate(150%)',
                    border: '1px solid rgba(254, 241, 225, 0.4)'
                  }}>
                ...
                <div className="w-80 flex-shrink-0">
                  <div className="bg-gray-900 text-white rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden shadow-xl">
                    <div className="absolute inset-0 bg-gradient-to-br from-black/40 via-black/60 to-black/80 z-10"></div>
                    <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=600&fit=crop&crop=center')"}}></div>
                    <div className="relative z-20 flex flex-col h-full pt-8">
                      <div className="mb-1">
                        <span className="text-xs font-medium text-white/90 tracking-wide">Snackpass Stories</span>
                      </div>
                      <div className="flex-1"></div>
                      <div className="flex-1 mb-8">
                        <blockquote className="leading-relaxed text-lg font-normal text-white">
                          "Implementing Snackpass wasn't just a tech upgrade; it was a revenue game-changer."
                        </blockquote>
                      </div>
                      <div className="flex-shrink-0">
                        <h3 className="text-white text-3xl font-bold leading-none">Empanada Factory</h3>
