      ...
      >
        ...
        {isExpanded && (
          ...
          >
            ...
            {/* Testimonials Section - Part of the expanded content */}
            <div className="bg-gray-50 pt-12 pb-20 -mx-12 rounded-b-[3rem]">
              <div className="container mx-auto px-20 max-w-[1400px]">
                ...
                <div className="hidden lg:grid lg:grid-cols-4 gap-6 items-start">
                  ...
                  <div className="lg:col-span-3 grid grid-cols-3 gap-6">
                    <div className="space-y-6">
                      <div className="bg-gray-900 text-white rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden">
                    ...
                    <div className="space-y-6">
                      <div className="rounded-3xl h-[580px] p-8 flex flex-col relative overflow-hidden" style={{
